        ...
        return (
            <div>
                ...
                <div className="blurb">
                    ...
                    A <a href={waiver} target="_blank" rel="noopener noreferrer">Waiver</a> form is signed by the person collecting the equipment. <a href={electrical} target="_blank" rel="noopener noreferrer">Electrical equipment checklist</a> and <a href={cleaning} target="_blank" rel="noopener noreferrer">Cleaning checklist</a> for the person donating the equipment.<br /><br />
